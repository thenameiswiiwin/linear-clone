...
export const UnlikeAnyTools = () => (
  <div className="text-white">
    ...
    <div className="flex flex-wrap gap-6">
      <div className="flex min-h-[48rem] basis-[calc(66.66%-12px)] flex-col justify-end rounded-[4.8rem] border border-gray-100 bg-glass-gradient p-8 text-center md:p-14">
      ...
      <div className="flex min-h-[48rem] basis-[calc(33.33%-12px)] flex-col justify-end rounded-[4.8rem] border border-gray-100 bg-glass-gradient p-8 text-center md:p-14">
